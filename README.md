...
and a worker discharges it with one full rebuild that readers see all at once
(ADR 0041, ADR 0118). On the
...
deliberately not a general document pipeline (docs/adr/0072).

# 0027 — Reference data is governed, additive, and never invented from source strings

- **Status:** Accepted — implemented on the `feat/reference-data-foundation` branch, pending integration
- **Date:** 2026-08-23
...
> **Numbering note.** ADR 0027 may be claimed concurrently by the
> `feat/matter-engagement` branch. Whichever lands second is renumbered at
> integration; nothing in this document depends on the number.

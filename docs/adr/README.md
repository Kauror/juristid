...
| [0056](0056-a-baseline-holds-the-product-not-the-clock-or-the-seed.md) | A baseline holds the product, not the clock and not the seed | Proposed, on a feature branch |

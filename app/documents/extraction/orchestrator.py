...
def pending_versions() -> Any:
    ...
    **`INTAKE_READ` is not here, and that is the point of it.** A binary
    ...
    had the answer to — which is what this system did until docs/adr/0069.
    ...
    **There is no scan gate in front of this any more.** It used to exclude
    ...
    subsystem it belonged to (docs/adr/0066 §Superseded, docs/adr/0069). What
...
def parse_source(
    ...
    **There is no scan state parameter any longer.** This function used to
    ...
    that refusal is gone (docs/adr/0069). What remains — the size limit, the

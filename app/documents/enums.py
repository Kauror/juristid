...
class MalwareScanState(models.TextChoices):
    ...
    The malware subsystem was removed in docs/adr/0069: there is no scanner,
    ...
    neatness (docs/adr/0069 §What is left behind).
...
class ExtractionState(models.TextChoices):
    ...
    # exactly the write amplification docs/adr/0069 was written to end. This

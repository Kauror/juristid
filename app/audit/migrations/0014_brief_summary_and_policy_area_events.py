"""Two new `ChangeEventType` values for the Teema redesign.

A `choices` change on an existing column: no data moves, no row is rewritten,
...
class Migration(migrations.Migration):
    dependencies = [
        ("audit", "0013_change_event_operation_id"),
    ]

"""The vocabulary learns MATTER_DATA_CLASS_CHANGED.

Choices only: `event_type` is a plain CharField, so nothing about the stored
column changes and no existing audit row is touched. This is the same shape as
every earlier event-type migration in this app, and it exists because the
enumeration is the readable half of the audit trail (docs/adr/0024).
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('audit', '0010_register_cutover_event_types'),
    ]
